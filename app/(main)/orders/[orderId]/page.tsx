...
/**
 * @file app/(main)/orders/[orderId]/page.tsx
 * @description 소매점 주문 상세 페이지
 *
 * 이 페이지는 소매점이 주문한 상품의 상세 정보를 확인하는 페이지입니다.
 *
 * 주요 기능:
 * 1. 주문 상세 정보 표시
 * 2. 상품 정보 표시
 * 3. 도매점 연락처 표시 (주문 확인 후)
 * 4. 주문 취소 버튼 (상태가 'pending'일 때만)
 *
 * 핵심 구현 로직:
 ...
 * - @/lib/types: Order
 *
 * @see {@link docs/PRD.md} - 주문 상세 페이지 명세
 * @see {@link docs/TODO.md} - TODO 839-844 라인
 */
            ...
            <CardContent className="space-y-3">
              ...
              {order.vendor_phone && (
                <div>
                  ...
                  <p className="font-semibold">{order.vendor_phone}</p>
                </div>
              )}
            </CardContent>
          </Card>
